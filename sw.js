const CACHE='vybe-v9';
const CORE=['./','./index.html','./style.css','./script.js','./app.js','./production-mode.js','./live-player.js','./production-polish.js','./vybe-config.js','./vybe-backend.js','./manifest.json','./icon.svg'];
